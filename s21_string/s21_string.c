...
int main(){
     char* src = "Airplane sematary";
     char destA [15]= "123456789000000";
     char destB [15]= "123456789000000";
     const char* srcx = "qwerty";
    char* a = s21_strchr(src, '\0');
   // printf("%p", s21_strchr(src, '\0'));
    if (a==strchr(src, '\0')){
        printf("Success 5!\n");
    }
    if ( strncmp("Hello\0", "Hello", 100) == s21_strncmp("Hello\0", "Hello", 100)){
        printf("Success 6!\n");
    }
    char* b =  strncpy(destA, srcx, 10);
    char* c = s21_strncpy(destB, srcx, 10);
    if (s21_strncmp(b, c, 10) == 0){
        printf("Success 7!\n");
    }
    //printf("%d", (int)s21_strcspn("Hello", "0"));
    char res[30];
    s21_sprintf(res, "Count: %d pe", 24);
    printf("%s", res);
    printf("\nCountkjhkj: %5.2f pe", 2.0);
    char* ab;
    char* ac;
    ab = strerror(50);
    ac = s21_strerror(50);
    if(s21_strncmp(ab, ac, 100) == 0)
    {
        printf("NICE");
    }
...
int s21_strncmp(const char *str1, const char *str2, size_t n) {
    ...
    if (n>strlen(str2)) n = strlen(str2);
...
size_t s21_strcspn(const char *str1, const char *str2){
    int fl = 0;
    size_t res = strlen(str1);
    for (size_t i = 0; i<strlen(str1)&&fl==0; i++){
        for(size_t j = 0; j<strlen(str2)&&fl==0; j++){
            if (*(str1+i)==*(str2+j)){
                fl = 1;
                res = i;
            }
